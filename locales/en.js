export default {
  ...
  welcomeDescription: 'The system is a complete system for finding lost articles in the metro stations and buses and other places',
  email: 'Email',
  password: 'Password',
  ...
  logs: 'Records',
  loadMore: 'Load more',
  addNewItem: 'Add new article',
  itemType: 'Article type',
  chooseStation: 'Choose station',
  lostDate: 'Lost date',
  lostTime: 'Lost time',
  writeItemType: 'Write article type',
  lostItemCost: 'Lost article cost',
  ...
  date: 'Date',
  location: 'Location',
  itemsArchive: 'Articles archive',
  items: 'Articles',
  isDelivered: 'Collected by owner',
  itemAdded: 'Article added successfully',
  addItemHolderDetails: 'Add receiver details',
  employeeName: 'Employee name',
  print: 'Print',
  mainCategories: 'Main categories for articles',
  viewAll: 'View all',
  latestItems: 'Latest articles',
  locations: 'Locations',
  allCategories: 'All categories',
  totalItems: 'Total articles',
  totalItemsDelivered: 'Total articles delivered',
  totalStation: 'Total stations',
  totalEmployees: 'Total employees',
  metroStations: 'Metro stations',
  busStations: 'Bus stations',
  itemsReports: 'Article reports',
  itemsLengthForYear: 'Articles length for year',
  dailyReports: 'Daily reports for articles',
  item: 'Article',
  from: 'From',
  to: 'To',
  ...
  itemPreview: 'Article preview',
  show: 'Show',
  welcome: 'Welcome',
  enqueryItem: 'inquiry article',
  registerNewItem: 'Add new article',
  reportItem: 'Report article',
  chooseStorage: 'Choose storage',
  image_deleted: 'Image deleted',
  delete_image: 'Delete image',
  informerName: 'Informer name',
  informerPhone: 'Informer phone',
  recieveName: 'Receiver name',
  recievePhone: 'Receiver phone',
